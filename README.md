# VIRTUALBOX-AND-KALI-LINUX-SET-UP
...
As part of my Ethical Hacking Internship with NetworkWalks, I began by setting up a controlled virtual lab environment for cybersecurity and penetration-testing exercises.

The goal of this first task was to create a secure and isolated environment where I can safely perform future ethical hacking labs, security testing, and practical exercises without affecting my host system or external networks.
...
Set up a virtualization environment using VirtualBox.
Install and configure Kali Linux.
Create an isolated private NAT network.
